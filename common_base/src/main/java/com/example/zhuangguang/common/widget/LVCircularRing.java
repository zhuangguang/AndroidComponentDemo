...
public class LVCircularRing  extends View{
    ...
    public LVCircularRing(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LVCircularRing(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LVCircularRing);
        barColor = a.getColor(R.styleable.LVCircularRing_bgColor, bgColor);
